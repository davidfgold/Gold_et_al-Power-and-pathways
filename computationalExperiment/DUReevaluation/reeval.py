...
#for i in range(24):
command_gen_tables1 = "./triangleSimulation -T {} -t 2344 -r {} -d {} -C 1 -O python_tables/rof_tables_test_problem_rdm_{} -e 0 -U TestFiles/rdm_utilities_test_problem_reeval.csv -W TestFiles/rdm_water_sources_test_problem_reeval.csv -P TestFiles/rdm_dmp_test_problem_reeval.csv -R {} -s {} -m 0 -p false".format(OMP_NUM_THREADS, N_REALIZATIONS, DATA_DIR, RDM + rank + N_NODES * i, RDM + rank + N_NODES * i, SOLS_FILE_NAME)
